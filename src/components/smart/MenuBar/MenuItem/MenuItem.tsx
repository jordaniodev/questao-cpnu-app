...
export const MenuItem = ({className, icon, label, url, hasShortly}: MenuItemProps) => {
  return (
    <Link href={url} className={`flex gap-2 flex-col md:flex-row md:h-6 text-foreground  px-2 py-4 items-center rounded-md bg-background border-none shadow-none hover:bg-sidebar-accent md:bg-sidebar-background ${className}`}>
        {icon}
